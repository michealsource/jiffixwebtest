            ...
            <Row className='py-5 d-flex align-items-center bottom-row-wrapper'>
                ...
                <Col className="start-from-here col-md-5" style={{marginRight:"70px", height:"100%", paddingTop:"50px"}}>
                 ...
                 {activeTab ==="signup" ?
                  ...
                  : activeTab ==="login"? <div className='choose-text-login'><p>Need a quick service, repair or maintenance? Our instant quote gives you real time pricing for the selected services available. There hasn't been anything better than knowing your cost upfront!</p></div>:
